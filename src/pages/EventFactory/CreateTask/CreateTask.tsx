    ...
    >
      ...
      >
        ...
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          <Switch>
            <Route exact path="/aut-dashboard/event-factory/create-task" component={CategoryStep} />
            <Route path="/aut-dashboard/event-factory/create-task/roles" component={RolesStep} />
            <Route path="/aut-dashboard/event-factory/create-task/description" component={DescriptionStep} />
          </Switch>
        </Box>
      </Box>
    </Container>
