...
const CallInformationStep = () => {
  ...
  return (
    <>
      ...
      />
      <StepWrapper className="sw-info-wrapper" autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
        <Box sx={{ display: 'flex', flex: 1 }}>
          ...
          >
            <Typography sx={{ mb: pxToRem(20), fontSize: pxToRem(25) }} color="white">
              {startDate && format(new Date(startDate), 'PPPP')}
            </Typography>
            <Typography sx={{ mb: pxToRem(20) }} color="white" fontSize={pxToRem(18)}>
          ...
          >
            ...
            >
              ...
              <Typography sx={{ mb: pxToRem(20), fontSize: pxToRem(18) }} color="white">
              ...
              <Controller
                ...
                render={({ field: { name, value, onChange } }) => {
                  return (
                    ...
                    >
                      {roles.map((r, index) => (
                        <MenuItem key={`role-option-key-${r.roleName}-${index}`} value={r.roleName}>
                          {r.roleName}
                        </MenuItem>
                      ))}
                    </AutSelectField>
