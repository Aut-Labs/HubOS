...
import { CardActionArea, CardContent, Container, Divider, Grid, Typography, useTheme } from '@mui/material';
...
const Integrations = () => {
  ...
  useEffect(() => {
    dispatch(setTitle(`Intergrations & Contracts - The Operating System for your DAO`));
  }, [dispatch]);
  ...
  return (
    ...
    >
      <Grid container flex="1" justifyContent="space-around" alignItems="center" spacing={5}>
        {IntegrationCards.map(({ title, description, disabled, route, routeDesc }, n) => (
          <Grid item key={n}>
            <Card
              sx={{
                height: pxToRem(480),
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Typography color="white" fontSize={pxToRem(32)} component="div" marginBottom={pxToRem(45)}>
                      {title}
                    </Typography>
                    <Typography color="white" fontSize={pxToRem(18)} component="div">
                      {description}
                    </Typography>
                  </div>
